...
export const COMMON_POINT_CARD_INFO: Record<CommonPointCardType, Pick<Card, "name" | "isBomb">> = {
...
export const COMMON_SPECIAL_CARD_INFO: Record<CommonSpecialCardType, Pick<Card, "name" | "isBomb">> = {
...
export const RARE_CARD_INFO: Record<RareCardType, Pick<Card, "name">> = {
  change: { name: "Change" },
